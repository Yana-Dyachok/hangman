import { keyboard, incorectGuess, man, mansHead, mansBody, mansLeftHand, mansRightHand, mansLeftLeg, mansRightLeg } from "./create.js";
...
function addOpacity(length, numb) {
  const array = [mansHead, mansBody, mansLeftHand, mansRightHand, mansLeftLeg, mansRightLeg]
